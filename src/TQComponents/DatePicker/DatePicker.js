...
class DatePicker extends Component {
  ...
  componentDidUpdate(prevProps, prevState) {
    ...
    if(prevProps.value!== this.state.selectedDate && this.state.selectedDate === null){
      
      this.setState({selectedDate:prevProps.value});
    }
...
//     if(nextProps.value!==nextState.selectedDate ){
//       return { selectedDate:nextState.selectedDate};
//    }else if(nextProps.value===nextState.selectedDate ){
//     return { selectedDate:nextState.selectedDate};
//  }
...
//     return { selectedDate:props.value};
//  }
//  else return null;
//  }
  render() {
...
export { DatePicker as TQDatePicker };
