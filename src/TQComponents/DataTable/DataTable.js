...
class DataTable extends Component {
  ...
  render() {
    ...
    if (exportToCSV) {
      try {
        ExportToCsvBtn = require('./DataTableComponents/ExportToCSV').default;
      } catch (err) {
        console.log(
        ...
        <div className="row">
          ...
          >     {exportToCSV && (
            <div className="col text-right ">
              <ExportToCsvBtn columns={columns} data={data.mapRows||[]} className="btn-download" >
              <MDBIcon icon="file-excel" size="lg" className="blue-text"> Download   </MDBIcon>
...
export { DataTable as TQDataTable };
