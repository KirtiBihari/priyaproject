  ...
  function _class() {
    ...
    return (
      (_ret = ((_temp = ((_this = _possibleConstructorReturn(
        this,
        (_ref = _class.__proto__ || Object.getPrototypeOf(_class)).call.apply(
          _ref,
          [this].concat(args)
        )
      )),
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.componentDidMount = function() {
    ...
    if (src) {
      _this2.createPromise = new _Form2.default(_this2.element, src, options)
        .render()
    ...
    if (form) {
      _this2.createPromise = new _Form2.default(_this2.element, form, options)
        .render()
        .then(function(formio) {
          _this2.formio = formio;
  ...
  this.componentWillReceiveProps = function(nextProps) {
    ...
    if (src !== nextProps.src) {
      _this2.createPromise = new _Form2.default(
        _this2.element,
        nextProps.src,
        options
      )
  ...
  this.emit = function(funcName) {
    return function() {
      if (
        _this2.props.hasOwnProperty(funcName) &&
        typeof _this2.props[funcName] === 'function'
      ) {
        var _props3;
