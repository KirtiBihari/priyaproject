...
import BpmnPropertiesPanel from './properties-panel/bpmn/BpmnPropertiesPanel';
...
class BpmnModelerComponent extends Component {
  ...
  propertiesPanel = new PropertiesPanel({
    container: this.propertiesPanel,
    ...
    return (
      <Fragment>
        <div className="contentb">
          <div id="canvas" onDropCapture={this.handleSave}/>
          <div id="properties-panel" ref={this.propertiesPanel}/>
