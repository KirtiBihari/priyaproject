...
class AddProcessForms extends Component {
  ...
  componentDidMount () {
    if (this.props.formid) {
      ...
      this.props.editProcessForm (this.props.formid);
    }
  }
          ...
          ? <React.Fragment>
              <div className="d-flex ">
                ...
                <div className="ml-auto">
                  ...
                  <MDBBtn tag="a" size="sm" floating color="blue" onClick={this.onFormSave}>
                    <MDBIcon icon="save" />
                  </MDBBtn>
                  <MDBBtn
                    tag="a"
...
export default connect (mapStateToProps, mapDispatchToProps) (AddProcessForms);
